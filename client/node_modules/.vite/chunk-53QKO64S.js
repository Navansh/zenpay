...
function useCompoundParent() {
  const [subitems, setSubitems] = React21.useState(new Map());
  const subitemKeys = React21.useRef(new Set());
...
var computePosition2 = (reference2, floating, options) => {
  ...
  return computePosition(reference2, floating, __spreadProps(__spreadValues({}, mergedOptions), {
...
function useFloating(options) {
  ...
  return React42.useMemo(() => __spreadProps(__spreadValues({}, data), {
    update,
    refs,
    elements,
    floatingStyles
 ...
 */
//# sourceMappingURL=chunk-53QKO64S.js.map
